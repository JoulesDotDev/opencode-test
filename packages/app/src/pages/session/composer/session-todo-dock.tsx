...
export function SessionTodoDock(props: {
  ...
  const collapsedText = createMemo(() => (props.collapsed ? preview() || label() : label()))
            ...
            <div class="min-w-0 flex items-center gap-2">
              ...
              <Tag
                ...
                style={{
                  ...
                  transition:
                    "opacity 180ms var(--tool-motion-ease, cubic-bezier(0.22, 1, 0.36, 1)), transform 180ms var(--tool-motion-ease, cubic-bezier(0.22, 1, 0.36, 1))",
                }}
              >
                {props.continueLabel}
              </Tag>
