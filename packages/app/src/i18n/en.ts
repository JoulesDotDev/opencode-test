export const dict = {
  ...
  "prompt.toast.pasteUnsupported.description": "This file could not be attached.",
  ...
  "session.followupDock.moveUp": "Move queued message up",
  "session.followupDock.moveDown": "Move queued message down",
  ...
  "settings.mcp.server.type.remote": "Remote",
  "settings.mcp.form.title.add": "Add MCP Server",
  "settings.mcp.form.title.edit": "Edit MCP Server",
  "settings.mcp.form.field.name.label": "Name",
  "settings.mcp.form.field.name.placeholder": "my-mcp-server",
  "settings.mcp.form.field.name.description": "Unique identifier for this server",
  "settings.mcp.form.field.type.label": "Type",
  "settings.mcp.form.field.command.label": "Command",
  "settings.mcp.form.field.command.placeholder": "npx -y @modelcontextprotocol/server-filesystem /path",
  "settings.mcp.form.field.command.description": "Command and arguments to run the MCP server",
  "settings.mcp.form.field.url.label": "URL",
  "settings.mcp.form.field.url.placeholder": "https://example.com/mcp",
  "settings.mcp.form.field.headers.label": "Headers",
  "settings.mcp.form.field.headers.key.placeholder": "Authorization",
  "settings.mcp.form.field.headers.value.placeholder": "Bearer token",
  "settings.mcp.form.field.headers.add": "Add header",
  "settings.mcp.form.field.headers.remove": "Remove header",
  "settings.mcp.form.field.oauth.label": "OAuth",
  "settings.mcp.form.field.oauth.description": "Enable OAuth authentication for this server",
  "settings.mcp.form.field.oauth.clientId.label": "Client ID",
  "settings.mcp.form.field.oauth.clientId.placeholder": "Optional — uses dynamic registration if empty",
  "settings.mcp.form.field.oauth.clientSecret.label": "Client Secret",
  "settings.mcp.form.field.oauth.scope.label": "Scope",
  "settings.mcp.form.field.oauth.scope.placeholder": "read write",
  "settings.mcp.form.field.enabled.label": "Enabled",
  "settings.mcp.form.field.enabled.description": "Connect this server on startup",
  "settings.mcp.form.validation.nameRequired": "Name is required",
  "settings.mcp.form.validation.nameTaken": "A server with this name already exists",
  "settings.mcp.form.validation.commandRequired": "Command is required",
  "settings.mcp.form.validation.urlRequired": "URL is required",
  "settings.mcp.toast.added.title": "Server added",
  "settings.mcp.toast.added.description": "{{name}} has been added",
  "settings.mcp.toast.updated.title": "Server updated",
  ...
  "ui.permission.rememberAllow": "No more for this command",
  "ui.permission.fullAccess": "Full access",
